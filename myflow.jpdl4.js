...
$.extend(true,myflow.config.tools.states,{
			...
			//设备1
			eq0 : {showType: 'text',type : 'eq0',
				name : {text:'<<eq0>>'},
				text : {text:'设备A'},
				img : {src : 'img/48/task_empty.png',width :48, height:48},
				
				props : {
					text: {name:'text', label: '位号', value:'', editor: function(){return new myflow.editors.textEditor();}, value:'设备位号'},
					equipmentType: {name:'equipmentType', label: '设备类型', value:'设备A', editor: function(){return new myflow.editors.inputEditor();}},
					temp2: {name:'temp2', label : '选择', value:'', editor: function(){return new myflow.editors.selectEditor('select.json');}}
					//equipmentType: {name:'desc', label : '设备类型', value:'', editor: function(){return new myflow.editors.inputEditor();}，value:'设备A'}
			...
			task: {showType: 'text',type : 'task',
				...
				img : {src : 'img/48/task_empty.png',width :48, height:48},
				props : {
					text: {name:'text', label: '位号', value:'', editor: function(){return new myflow.editors.textEditor();}, value:'任务'},
					...
					equipmentType: {name:'desc', label : '设备类型', value:'', editor: function(){return new myflow.editors.selectEditor({eqType:"equipmentType"});}}
				}}
